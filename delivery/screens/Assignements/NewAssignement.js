...
export class NewAssignement extends React.Component {
    ...
    _onDayPress(date) {
        this.setState({ date: moment(date).format('DD-MM-YYYY'), isCollapsed: true });
        ...
        return (
            <SafeAreaView
                ...
                <KeyboardAwareScrollView
                    ...
                    <ScreenHeader title="Nueva Asignación" navigation={this.props.navigation} />
                    ...
                    <TouchableOpacity
                        ...
                        <Text style={{ color: 'white', fontFamily: 'roboto-bold' }}>SIGUIENTE: PAGO</Text>
                    </TouchableOpacity>
                    <KeyboardShift>
                        {() => (
         ...
         <TouchableOpacity
             ...
             <Text style={styles.dateText}>{this.state.date}</Text>
                                ...
                                {this.state.locations.length === 0 && <Text style={[styles.placeholder, { marginTop: 15 }]}>Aún no has seleccionado ningún destino</Text>}
                                <View>
                                    {
                                        this.state.locations.map((item, index) => (
                                            <View key={index}>
                                                <TouchableOpacity
                                                    onPress={() => this.props.navigation.navigate('Map', { location: item, index })}>
                                                    <View style={styles.location}>
                                                        <View style={styles.locationInfo}>

                                                            <View>
                                                                <Text style={styles.locationAddress}>{item.address}</Text>
                                                                <Text multiline={true} style={styles.locationDescription}>{item.brief}</Text>
                                                            </View>
                                                        </View>
                                                        <TouchableOpacity
             ...
             <EvilIcons name="chevron-down" size={18} color="#8c8c8c"/>*/}
                                ...
                                <TouchableOpacity
                                    ...
                                    <Text style={{ marginLeft: 15, fontFamily: 'roboto' }}>AÑADIR DESTINO</Text>
                                </TouchableOpacity>
