    ...
    render() {
        const { children, header } = this.props,
            ...
            animatedPadding = this._animatedPadding.interpolate({
                inputRange: [this.config.position.end, this.config.position.start],
                outputRange: [this.config.top_padding.end, this.config.top_padding.start],
            }),
        ...
        return (
            <Animated.View style={[styles.container]}>
                ...
                <Animated.View style={[
                    styles.backdrop, { opacity: animatedOpacity }
                ]}>
                ...
                {/* Content container */}
                <Animated.View
                    style={[styles.content, this.getContentStyle(), {
                ...
                >
                    <View style={{position: 'absolute', top: 10, right: 0, left: 0, justifyContent: 'center', alignItems: 'center'}}>
                        <View style={[{height: 6, width: 45, borderRadius: 10}, this.state.pulling ? {backgroundColor: 'white'} : {backgroundColor: '#d69c31'} ]}></View>
                    </View>
